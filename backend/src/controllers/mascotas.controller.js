...
export const registrarMascota = async (req, res) => {
    try {
        const { id_mascotas, nombre_mascotas, genero_mascotas, edad_mascota, tamaño_mascota, color_mascota, esterilizacion, vacunas, desparacitacion, fecha_ult_desparacitacion, discapacidad, descripcion_discapacidad, compatibilidad_ninos, compatibilidad_otros_animales, imagen, estado, fk_id_categoria, fk_id_raza } = req.body;

        const [result] = await pool.query(
            `INSERT INTO mascotas (id_mascotas, nombre_mascotas, genero_mascotas, edad_mascota, tamaño_mascota, color_mascota, esterilizacion, vacunas, desparacitacion, fecha_ult_desparacitacion, discapacidad, descripcion_discapacidad, compatibilidad_ninos, compatibilidad_otros_animales, imagen, estado, fk_id_categoria, fk_id_raza) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
            [id_mascotas, nombre_mascotas, genero_mascotas, edad_mascota, tamaño_mascota, color_mascota, esterilizacion, vacunas, desparacitacion, fecha_ult_desparacitacion, discapacidad, descripcion_discapacidad, compatibilidad_ninos, compatibilidad_otros_animales, imagen, estado, fk_id_categoria, fk_id_raza]
        );
...
export const actualizarMascota = async (req, res) => {
    try {
        ...
        const [result] = await pool.query(
            `UPDATE mascotas SET nombre_mascotas=?, genero_mascotas=?, edad_mascota=?, tamaño_mascota=?, color_mascota=?, esterilizacion=?, vacunas=?, desparacitacion=?, fecha_ult_desparacitacion=?, discapacidad=?, descripcion_discapacidad=?, compatibilidad_ninos=?, compatibilidad_otros_animales=?, imagen=?, estado=?, fk_id_categoria=?, fk_id_raza=? WHERE id_mascotas = ?`,
            [
                updateMascotas.nombre_mascotas, updateMascotas.genero_mascotas, updateMascotas.edad_mascota,
                updateMascotas.tamaño_mascota, updateMascotas.color_mascota, updateMascotas.esterilizacion,
